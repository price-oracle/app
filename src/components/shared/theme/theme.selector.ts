...
export const THEME_TEXT_SECONDARY = (props: PropTheme) => THEME.textSecondary;

export const THEME_DISABLED = (props: PropTheme) => THEME.textDisabled;

export const THEME_DIVIDER = (props: PropTheme) => THEME.divider;

export const THEME_BORDER = (props: PropTheme) => `2px solid ${THEME.divider}`;

export const THEME_ACTION_ACTIVE = (props: PropTheme) => THEME.actionActive;

export const THEME_ACTION_DISABLED = (props: PropTheme) => THEME.actionDisabled;

export const THEME_ACTION_DISABLED_BACKGROUND = (props: PropTheme) => THEME.actionDisabledBackground;

export const THEME_ACTION_HOVER = (props: PropTheme) => THEME.actionHover;

export const THEME_ACTION_SELECTED = (props: PropTheme) => THEME.actionSelected;
